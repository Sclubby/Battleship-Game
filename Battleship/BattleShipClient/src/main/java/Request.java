...
public class Request implements Serializable {
    ...
    /*
    -4 - player denied another players request
    -1 - request players from server
    ...
    */
    ...
    /*
    Request connection to server or a new game or to deny a notification from a player
    @param requestType 0 for connection to server request and 1 for new game request
    @param username The player username if requestType is 0
     the opponent username if requestType is 1
     -4 and the rejected opponent for a rejected request
     */
    ...
    /*
    Request cancellation of a previous new game request (-4) or request all players from server (-1)
